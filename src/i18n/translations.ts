...
export interface Translations {
  ...
  rel_friend: string;
  rel_best_friend: string;
  rel_legend: string;
  atlas_friendship_hint: string;
  season_tag: string;
  season_title: string;
  season_desc: string;
  season_cta: string;
  ...
  atlas_duels: string;
  atlas_duels_played: string;
  atlas_duels_won: string;
  atlas_winrate: string;
  atlas_chat_title: string;
  atlas_chat_premium: string;
  atlas_chat_hint: string;
  atlas_chat_placeholder: string;
  atlas_chat_limit: string;
  atlas_chat_offline: string;
  atlas_chat_error: string;
  duel_mode: string;
  duel_desc: string;
  duel_you: string;
  duel_you_win: string;
...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    rel_friend: 'Friend',
    rel_best_friend: 'Best Friend',
    rel_legend: 'Legend',
    atlas_friendship_hint: 'Your friendship grows as you play together',
    ...
    atlas_duels_played: 'Played',
    atlas_duels_won: 'Won',
    atlas_winrate: 'Win rate',
    atlas_chat_title: 'Free chat',
    atlas_chat_premium: 'Free chat with ATLAS is reserved for the Premium Pass',
    atlas_chat_hint: 'Ask ATLAS anything — geography or not!',
    atlas_chat_placeholder: 'Your message...',
    atlas_chat_limit: 'That\'s enough for today, I need to rest my legendary brain. Come back tomorrow!',
    atlas_chat_offline: 'Hmm, no signal up here in the mountains. The chat needs the online server. Try later!',
    atlas_chat_error: 'Ugh, a hiccup. Even the best geographers get lost sometimes. Try again!',
  ...
  fr: {
    ...
    rel_friend: 'Ami',
    rel_best_friend: 'Meilleur Ami',
    rel_legend: 'Légende',
    atlas_friendship_hint: 'Votre amitié grandit en jouant ensemble',
    ...
    atlas_duels_played: 'Joués',
    atlas_duels_won: 'Gagnés',
    atlas_winrate: 'Victoires',
    atlas_chat_title: 'Conversation libre',
    atlas_chat_premium: 'La conversation libre avec ATLAS est réservée au Passe Premium',
    atlas_chat_hint: 'Demande tout à ATLAS — géo ou pas !',
    atlas_chat_placeholder: 'Ton message...',
    atlas_chat_limit: 'Ça suffit pour aujourd\'hui, je dois reposer mon cerveau légendaire. Reviens demain !',
    atlas_chat_offline: 'Hmm, pas de réseau ici en montagne. Le chat a besoin du serveur en ligne. Réessaie plus tard !',
    atlas_chat_error: 'Argh, un couac. Même les meilleurs géographes se perdent parfois. Réessaie !',
  ...
  es: {
    ...
    rel_friend: 'Amigo',
    rel_best_friend: 'Mejor Amigo',
    rel_legend: 'Leyenda',
    atlas_friendship_hint: 'Vuestra amistad crece jugando juntos',
    ...
    atlas_duels_played: 'Jugados',
    atlas_duels_won: 'Ganados',
    atlas_winrate: 'Victorias',
    atlas_chat_title: 'Chat libre',
    atlas_chat_premium: 'El chat libre con ATLAS es solo para el Pase Premium',
    atlas_chat_hint: '¡Pregúntale lo que sea a ATLAS!',
    atlas_chat_placeholder: 'Tu mensaje...',
    atlas_chat_limit: 'Suficiente por hoy, necesito descansar mi cerebro legendario. ¡Vuelve mañana!',
    atlas_chat_offline: 'Mmm, sin señal en la montaña. El chat necesita el servidor en línea. ¡Prueba luego!',
    atlas_chat_error: 'Uf, un fallo. Hasta los mejores geógrafos se pierden. ¡Inténtalo de nuevo!',
    duel_mode: '1v1 vs ATLAS',
  ...
  de: {
    ...
    rel_friend: 'Freund',
    rel_best_friend: 'Bester Freund',
    rel_legend: 'Legende',
    atlas_friendship_hint: 'Eure Freundschaft wächst beim gemeinsamen Spielen',
    ...
    atlas_duels_played: 'Gespielt',
    atlas_duels_won: 'Gewonnen',
    atlas_winrate: 'Siegrate',
    atlas_chat_title: 'Freier Chat',
    atlas_chat_premium: 'Freier Chat mit ATLAS nur mit Premium-Pass',
    atlas_chat_hint: 'Frag ATLAS alles — Geografie oder nicht!',
    atlas_chat_placeholder: 'Deine Nachricht...',
    atlas_chat_limit: 'Genug für heute, ich muss mein legendäres Gehirn ausruhen. Komm morgen wieder!',
    atlas_chat_offline: 'Hmm, kein Signal hier in den Bergen. Der Chat braucht den Online-Server. Versuch\'s später!',
    atlas_chat_error: 'Ups, ein Fehler. Selbst die besten Geografen verirren sich. Versuch\'s nochmal!',
  ...
  pt: {
    ...
    rel_friend: 'Amigo',
    rel_best_friend: 'Melhor Amigo',
    rel_legend: 'Lenda',
    atlas_friendship_hint: 'A amizade cresce jogando juntos',
    ...
    atlas_subtitle: 'Geógrafo · 150 países visitados',
    atlas_duels: 'Duelos vs ATLAS',
    atlas_duels_played: 'Jogados',
    atlas_duels_won: 'Vencidos',
    atlas_winrate: 'Vitórias',
    atlas_chat_title: 'Conversa livre',
    atlas_chat_premium: 'A conversa livre com ATLAS é exclusiva do Passe Premium',
    atlas_chat_hint: 'Pergunte qualquer coisa ao ATLAS!',
    atlas_chat_placeholder: 'Sua mensagem...',
    atlas_chat_limit: 'Chega por hoje, preciso descansar meu cérebro lendário. Volte amanhã!',
    atlas_chat_offline: 'Hmm, sem sinal nas montanhas. O chat precisa do servidor online. Tente depois!',
    atlas_chat_error: 'Eita, um erro. Até os melhores geógrafos se perdem. Tente de novo!',
    duel_mode: '1v1 vs ATLAS',
  ...
  zh: {
    ...
    rel_best_friend: '挚友',
    rel_legend: '传奇',
    atlas_friendship_hint: '一起游玩，友谊渐长',
    season_tag: '新赛季',
    ...
    atlas_duels_played: '场次',
    atlas_duels_won: '胜场',
    atlas_winrate: '胜率',
    atlas_chat_title: '自由聊天',
    atlas_chat_premium: '与 ATLAS 自由聊天为高级通行证专属',
    atlas_chat_hint: '随便问 ATLAS 任何问题！',
    atlas_chat_placeholder: '你的消息……',
    atlas_chat_limit: '今天够了，我得让传奇大脑休息一下。明天再来！',
    atlas_chat_offline: '嗯，山里没信号。聊天需要在线服务器。稍后再试！',
    atlas_chat_error: '哎呀，出错了。再厉害的地理学家也会迷路。再试一次！',
  ...
  ja: {
    ...
    rel_best_friend: '親友',
    rel_legend: '伝説',
    atlas_friendship_hint: '一緒に遊ぶほど友情が深まる',
    season_tag: '新シーズン',
    ...
    atlas_duels_played: '対戦数',
    atlas_duels_won: '勝利',
    atlas_winrate: '勝率',
    atlas_chat_title: 'フリートーク',
    atlas_chat_premium: 'ATLASとのフリートークはプレミアム限定',
    atlas_chat_hint: 'ATLASに何でも聞いてみて！',
    atlas_chat_placeholder: 'メッセージ…',
    atlas_chat_limit: '今日はここまで、伝説の頭脳を休ませる。また明日！',
    atlas_chat_offline: 'うーん、山では電波がない。チャットはオンラインサーバーが必要。後でね！',
    atlas_chat_error: 'おっと、不具合。名地理学者でも迷うもの。もう一度！',
    duel_mode: 'ATLASと1v1',
  ...
  ar: {
    ...
    rel_friend: 'صديق',
    rel_best_friend: 'أعز صديق',
    rel_legend: 'أسطورة',
    atlas_friendship_hint: 'تنمو صداقتكما باللعب معًا',
    ...
    atlas_duels_played: 'لُعبت',
    atlas_duels_won: 'فُزت',
    atlas_winrate: 'نسبة الفوز',
    atlas_chat_title: 'محادثة حرة',
    atlas_chat_premium: 'المحادثة الحرة مع ATLAS حصرية لبطاقة بريميوم',
    atlas_chat_hint: 'اسأل ATLAS أي شيء!',
    atlas_chat_placeholder: 'رسالتك...',
    atlas_chat_limit: 'يكفي اليوم، أحتاج لإراحة عقلي الأسطوري. عُد غدًا!',
    atlas_chat_offline: 'لا إشارة هنا في الجبال. الدردشة تحتاج خادمًا متصلًا. حاول لاحقًا!',
    atlas_chat_error: 'آه، خطأ ما. حتى أفضل الجغرافيين يضلّون أحيانًا. حاول مجددًا!',
